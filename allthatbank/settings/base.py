"""
Django settings for allthatbank project.
...
DEPOSIT_PRODUCTS_API = get_secret('DEPOSIT_PRODUCTS_API')
...
WSGI_APPLICATION = 'allthatbank.wsgi.application'
